"""
Email Generator Agent with Structured Output

This module defines an agent that generates structured email content
using a Pydantic model to ensure consistent output format.
"""
